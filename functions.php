<?php
/**
 * WBC Training functions and definitions
 *
...
if ( ! function_exists( 'wbc_training_setup' ) ) :
	 ...
	 */
	function wbc_training_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on WBC Training, use a find and replace
		 * to change 'wbc-training' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'wbc-training', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'wbc-training' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'wbc_training_custom_background_args',
				array(
